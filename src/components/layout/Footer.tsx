        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-xs max-w-xs">
              A comprehensive suite of free, high-performance web utilities for developers, designers, and content creators. Built for maximum speed, privacy, and ease of use.
            </p>
          </div>

          <div>
            <h4 className="font-semibold text-foreground mb-3">Popular Tools</h4>
          ...
          <div>
            <h4 className="font-semibold text-foreground mb-3">Privacy & Terms</h4>
            <p className="text-xs leading-relaxed">
              All tools run entirely client-side. Your inputs are never sent to a server. Your data stays 100% private and secure.
            </p>
          </div>
        </div>

        <div className="mt-8 border-t border-border/60 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs">&copy; {new Date().getFullYear()} ToolVerse. All rights reserved.</p>
